...
const ReportingCard: FC<Reporting> = async ({ image, name }) => {
  ...
  return (
    <article className="flex flex-col gap-2 xs:gap-3 sm:gap-4 md:gap-5 lg:gap-[22px] border-2 border-[#bfc1c2] rounded-md px-2 xs:px-3 sm:px-4 md:px-5 lg:px-[21px] pt-[6px] md:pt-2 lg:pt-[10px] pb-2 xs:pb-3 sm:pb-4 md:pb-5 lg:pb-6 shadow-reporting-card w-full min-w-[156px] max-w-[410px]">
