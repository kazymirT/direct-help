...
const About = () => {
  return (
    <div className="w-full pt-[90px] pb-[94px] flex justify-center">
      <div className="w-full max-w-[1490px] flex flex-col items-end gap-[211px]">
        <section className="flex flex-col gap-4">
        <h2 className="font-medium tracking-wide text-[40px] text-text2">Про  проєкт</h2>
        <div className="flex gap-[71px]">
        <div className="w-full max-w-[613px] text-3xl text-text2">
        ...
        <Image alt="" src='/about.png' width={676} height={507} className="relative pt-[96px] z-20"  />
          <div className="absolute top-[46px] -left-[58px] bg-[#0d1415] w-[237px] h-[227px] z-10"></div>
          <div className="absolute top-0 right-0 bg-[#f8b428] w-[322px] h-[297px]"></div>
          <div className="absolute -bottom-[95px] right-0 bg-[#0d1415] w-[363px] h-[95px]"></div>
