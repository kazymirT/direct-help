...
const PrivatForm = async () => {
  ...
  return (
    <section className="flex flex-col lg:pt-1 pt-10 sm:pt-9 md:pt-8 xl:pt-6 gap-[10px] lg:gap-0 xl:gap-2 w-full">
      ...
      <div className="pr-3 flex justify-between items-center w-full lg:max-w-[550px] xl:max-w-[738px] lg:pt-[30px] xl:pt-5">
      <div className="text-[#262222] font-light text-xs sm:text-sm md:text-base lg:text-[clamp(1rem,0.385rem+0.962vw,1.25rem)] leading-[1.15]">
        <p>{t('details-one')}</p>
        <p>{t('details-two')}</p>
        <p>{t('details-three')}</p>
        <p>{t('details-four')}</p>
