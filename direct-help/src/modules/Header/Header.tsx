...
const Header = async () => {
  ...
  return (
    <header className="w-full z-100 relative pt-[7px] pb-[11px] xs:pt-3 xs:pb-3 sm:pt-4 sm:pb-4 md:pt-5 md:pb-5 lg:pt-[26px] lg:pb-[48px] min-xl:pt-[32px] min-xl:pb-8 flex justify-center">
