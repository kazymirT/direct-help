...
const About = async () => {
  ...
  const descriptionsCN = clsx('w-full max-xs:px-5.5 max-sm:max-w-full max-[850px]:max-w-9/10 min-[850px]:max-w-[40%] lg:max-w-[clamp(26.688rem,12.072rem+22.837vw,32.625rem)] text-[clamp(1rem,0.819rem+0.77vw,1.313rem)] lg:text-[clamp(1.313rem,0.236rem+1.683vw,1.75rem)] text-text2', {
  ...
  return (
    <div className={containerCN}>
      <div className={wrapperCN}>
        ...
        <h2 className="font-medium text-[clamp(1.5rem,1.236rem+1.127vw,2.25rem)] text-text2 max-xs:pl-5.5">{t('title')}</h2>
        ...
        <div className="relative pt-5 md:pt-10 lg:pt-[70px] xl:pt-[96px] h-fit max-[850px]:w-fit self-end xs:self-center">
        <Image alt="" src='/about.png' width={344} height={212} className="relative w-[clamp(21.5rem,-2.161rem+100.952vw,28.125rem)] xs:w-[400px] sm:w-[480px] lg:w-[clamp(30.625rem,3.394rem+42.548vw,41.688rem)] z-20 aspect-[1.62] md:aspect-[1.31]"  />
        ...
        <div className="w-full self-center flex justify-end max-xs:px-5.5">
