...
const Awards = async () => {
  ...
  return (
    <section className="w-full max-w-[1920px] m-auto flex gap-4 xs:gap-6 sm:gap-7 md:gap-8 lg:gap-9 xl:gap-10.5 flex-col items-end justify-end pt-4 xs:pt-6 sm:pt-8 md:pt-10 lg:pt-12 xl:pt-15 pb-9 xs:pb-12 sm:pb-15 md:pb-20 lg:pb-30 xl:pb-35">
